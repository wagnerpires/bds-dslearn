...
public abstract class Lesson implements Serializable {  // Classes abstratas não podem ser instanciadas (Herança total - Instanciar somente os tipos das subclasses)
